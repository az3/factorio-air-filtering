...
data.raw["furnace"]["air-filter-machine"].allowed_module_categories = {"speed", "effect"}
...
data.raw["furnace"]["air-filter-machine-mk2"].allowed_module_categories = {"speed", "effect"}
...
data.raw["furnace"]["air-filter-machine-mk3"].allowed_module_categories = {"speed", "effect"}
